...
SITE_BRAND = os.environ.get("SITE_NAME", "Sirius Asset Manager")
ADMIN_SITE_HEADER = os.environ.get("ADMIN_SITE_HEADER", SITE_BRAND)
ADMIN_SITE_TITLE = os.environ.get("ADMIN_SITE_TITLE", SITE_BRAND)
