...
api_urls = list(
    map(
        ...
        [
            ...
            "ralph.assets.api.costs",
            "ralph.assets.api.inventory",
            "ralph.assets.api.telemetry",
            "ralph.assets.api.analytics",
            "ralph.assets.api.reporting",
            "ralph.assets.api.safety",
...
urlpatterns = [
    ...
    re_path(r"^projects/", include("ralph.projects.urls")),
