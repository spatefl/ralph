        ...
        items=[
            ...
            ralph_item(
                ...
                children=[
                    ...
                    section(_("Excavators"), "heavy_equipment", "ExcavatorAsset"),
                    section(_("Bulldozers"), "heavy_equipment", "BulldozerAsset"),
                    section(_("Loaders"), "heavy_equipment", "LoaderAsset"),
                    section(_("Cranes"), "heavy_equipment", "CraneAsset"),
                    section(_("Forklifts & Telehandlers"), "heavy_equipment", "ForkliftAsset"),
                    section(_("Other Machinery"), "heavy_equipment", "OtherHeavyEquipmentAsset"),
                    section(_("Assignments"), "assets", "HeavyEquipmentDeploymentEntry"),
                    section(_("Usage Logs"), "assets", "HeavyEquipmentTelemetryReading"),
                    section(_("Maintenance Logs"), "assets", "HeavyEquipmentMaintenanceRecord"),
                    section(_("Status Logs"), "assets", "HeavyEquipmentAssetIncident"),
                ],
            ),
            ralph_item(
                title=_("Trailers"),
                ...
                perms_mode_all=False,
                children=[
                    section(_("All Trailers"), "trailers", "TrailerAsset"),
                    section(_("Command Trailers"), "trailers", "CommandTrailer"),
                    section(_("Office Trailers"), "trailers", "OfficeTrailer"),
                    section(_("Restroom Trailers"), "trailers", "RestroomTrailer"),
                    section(_("Shower Trailers"), "trailers", "ShowerTrailer"),
                    section(_("Laundry Trailers"), "trailers", "LaundryTrailer"),
                    section(_("Sleeping Quarters"), "trailers", "SleepingTrailer"),
                    section(_("Medical Trailers"), "trailers", "MedicalTrailer"),
                    section(_("Communications Trailers"), "trailers", "CommunicationsTrailer"),
                    section(_("Water Tank Trailers"), "trailers", "WaterTrailer"),
                    section(_("Storage Trailers"), "trailers", "StorageTrailer"),
                    section(_("Specialty Trailers"), "trailers", "SpecialtyTrailer"),
                    section(_("Assignments"), "assets", "TrailerDeploymentEntry"),
                    section(_("Usage Logs"), "assets", "TrailerTelemetryReading"),
                    section(_("Maintenance Logs"), "assets", "TrailerMaintenanceRecord"),
                    section(_("Status Logs"), "assets", "TrailerAssetIncident"),
                ],
            ),
            ralph_item(
                title=_("Power & Lighting"),
                url="#",
                url_as_pattern=False,
                perms_mode_all=False,
                children=[
                    section(_("All Power Assets"), "power", "PowerAsset"),
                    section(_("Generators"), "power", "GeneratorAsset"),
                    section(_("Light Towers"), "power", "LightTowerAsset"),
                    section(_("Battery & Solar Packs"), "power", "BatteryAsset"),
                    section(_("Pumps / Auxiliary Power"), "power", "PumpAsset"),
                    section(_("Assignments"), "assets", "PowerDeploymentEntry"),
                    section(_("Usage Logs"), "assets", "PowerTelemetryReading"),
                    section(_("Maintenance Logs"), "assets", "PowerMaintenanceRecord"),
                    section(_("Status Logs"), "assets", "PowerAssetIncident"),
                ],
            ),
            ralph_item(
                title=_("Fleet"),
            ...
            ralph_item(
                ...
                children=[
                    ...
                    ralph_item(
                        ...
                        access_by_perms="assets.view_asset",
                    ),
                    ralph_item(
